-- ============================================================================
-- 🏛️ Sentinax Migration 006: Macroeconomic Series & PIT Observations
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.macro_series (
    ...
    source_tier VARCHAR(32) NOT NULL DEFAULT 'tier_1',
...
CREATE TABLE IF NOT EXISTS public.macro_observations (
    ...
    data_status VARCHAR(32) NOT NULL DEFAULT 'complete',
...
-- ============================================================================
-- 3. Anti-Tamper Immutability Trigger for macro_observations
-- ============================================================================
...
BEGIN
    ...
    IF TG_OP = 'UPDATE' THEN
        IF (
            ...
            RAISE EXCEPTION 'Full-row immutability violation on macro_observations (id=%). Only supersession state may be updated.', OLD.id;
        END IF;
...
-- ============================================================================
-- 4. Point-in-Time (PIT) RPC for Macro Observations
-- ============================================================================
