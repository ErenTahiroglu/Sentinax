...
class MacroSeriesRegistry:
    ...
    _DEFINITIONS: Dict[str, MacroSeriesDefinition] = {
        ...
        "EA_ECB_DEPOSIT_FACILITY_RATE": MacroSeriesDefinition(
            ...
            verification_notes="Official ECB Deposit Facility Rate (Key Policy Rate).",
            is_active=True,
        ),
        "EA_ECB_MAIN_REFINANCING_RATE": MacroSeriesDefinition(
            ...
            verification_source="ECB Data Portal SDMX 2.1 Web Service Dataflow FM",
            verification_notes="Official ECB Main Refinancing Operations Fixed / Minimum Bid Rate.",
            is_active=True,
        ),
        ...
        # ─────────────────────────────────────────────────────────────────────
        # 6. Eurostat (Euro Area) — Supranational Official Statistics
        # ─────────────────────────────────────────────────────────────────────
        "EA_HICP_ALL_ITEMS_INDEX": MacroSeriesDefinition(
            canonical_key="EA_HICP_ALL_ITEMS_INDEX",
            provider="EUROSTAT",
            provider_series_code="prc_hicp_midx/M.I15.CP00.EA20",
            category=MacroCategory.INFLATION_CPI,
            description="Harmonised Index of Consumer Prices: All-Items (Index 2015=100, Euro Area 20)",
            unit=MacroUnit.INDEX_POINTS,
            frequency=MacroFrequency.MONTHLY,
            freshness_basis=FreshnessBasis.PUBLISHED_AT,
            source_tier=SourceTier.TIER_1_REGULATORY,
            geography="EA",
            provider_native_units="Index 2015=100",
            origin_source="Eurostat (Statistical Office of the European Union)",
            release_name="Harmonised Index of Consumer Prices",
            contract_status=ContractStatus.VERIFIED,
            expected_release_interval_days=31,
            source_url="https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/data/prc_hicp_midx/M.I15.CP00.EA20",
            verification_source="Eurostat SDMX 2.1 Dissemination API (prc_hicp_midx)",
            verification_notes="Official EA20 HICP headline index.",
            is_active=True,
        ),
        "EA_HICP_ALL_ITEMS_YOY": MacroSeriesDefinition(
            canonical_key="EA_HICP_ALL_ITEMS_YOY",
            provider="EUROSTAT",
            provider_series_code="prc_hicp_manr/M.RCH_A.CP00.EA20",
            category=MacroCategory.INFLATION_CPI,
            description="Harmonised Index of Consumer Prices: Annual Rate of Change (%) (Euro Area 20)",
            unit=MacroUnit.PERCENT,
            frequency=MacroFrequency.MONTHLY,
            freshness_basis=FreshnessBasis.PUBLISHED_AT,
            source_tier=SourceTier.TIER_1_REGULATORY,
            ...
            contract_status=ContractStatus.VERIFIED,
            expected_release_interval_days=31,
            source_url="https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/data/prc_hicp_manr/M.RCH_A.CP00.EA20",
            verification_source="Eurostat SDMX 2.1 Dissemination API (prc_hicp_manr)",
            verification_notes="Official EA20 HICP annual inflation rate.",
            is_active=True,
        ),
        "EA_UNEMPLOYMENT_RATE": MacroSeriesDefinition(
            canonical_key="EA_UNEMPLOYMENT_RATE",
            provider="EUROSTAT",
            provider_series_code="une_rt_m/M.SA.TOTAL.PC_ACT.T.EA20",
            category=MacroCategory.LABOR,
            description="Euro Area Seasonally Adjusted Unemployment Rate (% of active population)",
            unit=MacroUnit.PERCENT,
            frequency=MacroFrequency.MONTHLY,
            freshness_basis=FreshnessBasis.PUBLISHED_AT,
            source_tier=SourceTier.TIER_1_REGULATORY,
            ...
            contract_status=ContractStatus.VERIFIED,
            expected_release_interval_days=31,
            source_url="https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/data/une_rt_m/M.SA.TOTAL.PC_ACT.T.EA20",
            verification_source="Eurostat SDMX 2.1 Dissemination API (une_rt_m)",
            verification_notes="Official EA20 civilian unemployment rate.",
            is_active=True,
        ),
        "EA_REAL_GDP": MacroSeriesDefinition(
            canonical_key="EA_REAL_GDP",
            provider="EUROSTAT",
            provider_series_code="namq_10_gdp/Q.CLV10_MNAC.SCA.B1GQ.EA20",
            category=MacroCategory.OUTPUT,
            description="Euro Area Real Gross Domestic Product (Chain-linked volumes 2010, Million Euro, SCA)",
            ...
            contract_status=ContractStatus.VERIFIED,
            expected_release_interval_days=92,
            source_url="https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/data/namq_10_gdp/Q.CLV10_MNAC.SCA.B1GQ.EA20",
            verification_source="Eurostat SDMX 2.1 Dissemination API (namq_10_gdp)",
            verification_notes="Official EA20 Real GDP in chain-linked volume.",
            is_active=True,
        ),
